...
var buildable_units = {
	"Source": preload("res://scenes/units/Source.tscn"),
	"Sink": preload("res://scenes/units/Sink.tscn"),
	"Reactor": preload("res://scenes/units/ReactorProcess.tscn"),
	"Filter": preload("res://scenes/units/FilterProcess.tscn"),
